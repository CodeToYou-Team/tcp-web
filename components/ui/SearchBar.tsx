    ...
    >
      <div className="relative flex-1">
        ...
        <Input
          ...
          className="search-clear-yellow truncate bg-zinc-800 pl-10 text-sm text-zinc-100 placeholder:text-zinc-300 transition-[box-shadow,background-color,color] duration-200 ease-out"
        />
      </div>
      <Button
        type="submit"
