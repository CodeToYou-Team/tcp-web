  ...
  return (
    <>
      <div className="w-11/12 md:w-8/12 mt-6 md:mt-24 h-1/4 grid grid-cols-2 grid-rows-2 gap-4 mx-auto">
        <Image
          alt="Vehículos exhibidos en el showroom TUCARROPROPIO"
        ...
        />
        <Image
          alt="Vehículos en exhibición dentro de las instalaciones"
          className="rounded-lg h-full"
        ...
        />
        <Image
          alt="Detalle del interior de las oficinas"
          className="rounded-lg h-full"
        ...
        />
        <Image
          alt="Sede de TUCARROPROPIO vista desde el exterior"
          className="rounded-lg h-full"
